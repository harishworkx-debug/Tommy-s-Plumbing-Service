...
export const Route = createFileRoute("/services")({
  head: () =>
    pageHead({
      ...
      description:
        "Full list of plumbing services in Bakersfield, CA: repairs, emergency plumbing, drain cleaning, sewer, leak detection, pipes and water heaters. Call 661-319-9432.",
      path: "/services/",
    }),
